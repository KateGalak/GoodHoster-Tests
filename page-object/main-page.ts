...
export class MainPage {
  ...
  readonly vpsHostingTabs: Locator;

  constructor(page: Page) {
    this.page = page;
    this.topBar = page.locator("xpath=//div[@id='top-bar']");
    this.topBarRegistrationBlock = page.locator(
      "xpath=//div[@id='no-entered']"
    );
    this.topBarOnlineChat = page.locator(
      "xpath=//div[@id='online-chat-top-bar']"
    );
    ...
    this.header = page.locator(
      "xpath=//div[@class='nav-line container hide-for-small-only clearfix']"
    );
    this.footer = page.locator("xpath=//div[@id='footer-low']");
    this.footerLogo = page.locator(
      "xpath=//div[@class='medium-4 hide-for-small-only large-4 columns logo-foot']"
    );
    ...
    this.vpsHostingTabs = page.locator(
      "xpath=//div[@class='hosting-tabs-wrapper']"
    );
  }
